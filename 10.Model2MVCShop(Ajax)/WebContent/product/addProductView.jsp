...
/* function resetData(){
	...
	$(function(){
		$("td.ct_write01 img").on('click',function(){
			var date = show_calendar('document.detailForm.manuDate', $("input[name='manuDate']").val());
			$("input[name='manuDate']").val(date);
		});
	});
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input	type="file" id="uploadFile" name="uploadFile" class="ct_input_g" 
							style="width: 200px; height: 19px" maxLength=""/>
		</td>
	</tr>
	<tr>
